...
public class Part1_1_Linear_Program_Ex1 {
    public static void main(String[] args) {
        try {
            ...
            System.out.println("Assign a value to the variable \"a\": ");
            double a = in.nextDouble();
            System.out.println("The variable \"a\" = " + a);

            System.out.println("Assign a value to the variable \"b\": ");
            double b = in.nextDouble();
            System.out.println("The variable \"b\" = " + b);

            System.out.println("Assign a value to the variable \"c\": ");
